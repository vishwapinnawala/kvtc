                  ...
                  <td><input type="file" class="form-control form-control-sm" id="imageid" name="imageid"  /></td> 
                    ...
                    <td>
                      <div class="table-actions d-flex align-items-center gap-3 fs-6">
                       <button type="submit" formaction="/updatepost" class="btn btn-transparent text-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Update"><i class="bi bi-cloud-upload-fill"></i></button>
                       <button type="submit" formaction="/deletepost" class="btn btn-transparent text-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Delete"><i class="bi bi-trash-fill"></i></button>
                      </div>
                    </td>   
                    </form>                 
                  </tr>
