			...
			<div class="row">
				<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="fh5co-contact-info">
						...
						<ul>
							<li class="address">Kawanthissa Vocational Training Center,<br>
Kataragama Road, Thissamaharama, Sri Lanka.</li>
							<li class="phone"><a href="tel://0472239039">047-2239039</a></li>
							<li class="email"><a href="mailto:kvtcsrilanka@yahoo.co.in">kvtcsrilanka@yahoo.co.in</a></li>
							<li class="url"><a href="kvtc.lk">kvtc.lk</a></li>
						</ul>
					</div>
	...
	<iframe src="https://my.atlistmaps.com/map/dc1fdeaa-101b-412f-929f-47ad2557e8f6?share=true" allow="geolocation 'self' https://my.atlistmaps.com" width="100%" height="400px" frameborder="1" scrolling="no" allowfullscreen></iframe>
...
Vocational Education, Research &amp; Innovation</p>
	...
	<script src="{{asset('import/assets/js/google_map.js')}}"></script>
